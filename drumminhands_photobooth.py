...
emails_path = '/home/pi/Documents/drumminhands_photobooth/emails'
...
### Functions ###
#################
##function to receive text input from customer (Dasha)
def capture_text():
...
# definedisplayStatus("VOGUE",36) the photo taking function for when the big button is pressed
def start_photobooth():
	...
	input(pygame.event.get())
        ...
        displayStatus("Please print your first and last name",42)
        sleep(prep_delay)
        name = capture_text()
        displayStatus("Please print your email address",42)
        sleep(prep_delay)
        email = capture_text()
